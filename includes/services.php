<section class="services">
    ...
    <div class="services__list">
        ...
        <div class="services__list__block">
            ...
            <h2 class="services__list__block__heading"><a href="#">Carpenter</a></h2>
        ...
        <div class="services__list__block">
            ...
            <h2 class="services__list__block__heading"><a href="#">Jobs</a></h2>
        ...
        <div class="services__list__block">
            ...
            <h2 class="services__list__block__heading"><a href="#">Electrician</a></h2>
        ...
        <div class="services__list__block">
            ...
            <h2 class="services__list__block__heading"><a href="#">Auto-repair</a></h2>
        ...
        <div class="services__list__block">
            ...
            <h2 class="services__list__block__heading"><a href="#">Plumber</a></h2>
        ...
        <div class="services__list__block">
            ...
            <h2 class="services__list__block__heading"><a href="#">Hospital</a></h2>
            <span class="services__list__block__text">Lorem ipsum dolor sit amet consectetur adipisicing elit.
    ...
    <span class="view__all"><a href="#">View all &rarr;</a></span>
